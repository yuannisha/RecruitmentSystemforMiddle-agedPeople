...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__D41DCDA",
    appName: "RecruitmentSystemforMiddle-agedPeople",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.110.150,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_uhCgoT";
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      selectedIconPath: "static/images/tabbar/job-active.png",
      text: "职位"
    },
    {
